	...
	<body>
		...
		<table id="address">
			...
			<tr>
				...
				<td class="wideField" colspan="3"><input class="field" id="complete_address" disabled="true"></input></td>
			</tr>
		</table>
		<script>
		...
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB6jCALkjpw10kNTeQt62MQc5PSC8R5ioA&libraries=places&callback=initAutocomplete"
        async defer></script>
	</body>
</html>